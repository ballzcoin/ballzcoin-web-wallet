<section class="pre-footer">
  <div class="container">
    <p>
      The Ballzcoin Web Wallet does not hold your keys for you. We cannot access accounts, recover keys, reset passwords, nor reverse transactions. Protect your keys &amp; always check that you are on correct URL.
...
<footer class="footer" role="content" aria-label="footer" ng-controller='footerCtrl' >
  ...
  <article class="block__wrap" style="max-width: 1780px; margin: auto;">
    ...
    <section class="footer--left">
      ...
      <!-- <a href="/"><img src="images/ballzcoin-logo.png" height="45px" width="auto" alt="Ether Wallet" class="footer--logo"/></a> -->
    ...
    <section class="footer--cent" role="content">
	The Ballzcoin Web Wallet is based on the MyEtherWallet source code. It has been customized for use with Ballzcoin, including disabling incompatible features to avoid confusion / mistakes. Most of the help pages point to the original MyEtherWallet resources. For Ballzcoin specific help, please visit our Discord channel. Double-check the URL and SSL credentials before unlocking your wallet: <b>https://wallet.ballzcoin.org</b> For better security, it is highly recommended to download and run it offline: <a href="https://ballzcoin.org/wallet.html"> https://ballzcoin.org/wallet.html</a>
    ...
    <section class="footer--righ">
      <p>
        <a aria-label="Ballzcoin website" href="https://ballzcoin.org" target="_blank" rel="noopener noreferrer" role="link" tabindex="0">
          Ballzcoin Website
        </a>
      </p>
      <p>
        <a aria-label="discord" href="https://discord.gg/wtC7bNd" target="_blank" rel="noopener noreferrer" role="link" tabindex="0">
          Ballzcoin Discord Channel
        </a>
      </p>
      <p>
        <a aria-label="bitcointalk" href="https://bitcointalk.org/index.php?topic=5024656.0" target="_blank" rel="noopener noreferrer" role="link" tabindex="0">
          Ballzcoin Bitcointalk ANN
        </a>
      </p>
      <p>
        <a aria-label="explorer" href="https://explorer.ballzcoin.org" target="_blank" rel="noopener noreferrer" role="link" tabindex="0">
          Ballzcoin Blockchain Explorer
        </a>
      </p>
      <p>
        <a aria-label="github" href="https://github.com/ballzcoin" target="_blank" rel="noopener noreferrer" role="link" tabindex="0">
          Ballzcoin Github Repository
        </a>
      </p>
      <!-- <p>
